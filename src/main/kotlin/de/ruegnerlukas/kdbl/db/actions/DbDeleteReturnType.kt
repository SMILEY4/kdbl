 ...
 */
class DbDeleteReturnType(private val db: Database, private val sql: String, private val placeholders: List<String>) {
...
/**
 * A single "DELETE"-operations that returns rows (i.e. has a "returning"-clause)
 * @param db the database to use
 * @param sql the sql-string with possible placeholders
 * @param placeholders the names of the placeholders in the correct order
 */
...
/**
 * A single "DELETE"-operations that returns the number of affected rows
 * @param db the database to use
 * @param sql the sql-string with possible placeholders
 * @param placeholders the names of the placeholders in the correct order
 */
